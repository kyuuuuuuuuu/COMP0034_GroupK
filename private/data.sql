...
INSERT INTO `item` (`item_id`, `item_name`, `item_description`, `item_price`, `last_update`, `item_image`) VALUES (NULL, 'Beef burger with chips', 'Beef patty with cheese and onions, served with chips.', '3.59', CURRENT_TIMESTAMP, '../img/burger.jpeg');
INSERT INTO `item` (`item_id`, `item_name`, `item_description`, `item_price`, `last_update`, `item_image`) VALUES (NULL, 'Koleno', 'Traditional food of Czech of Republic, which is tender, juicy, crispy and fatty.', '2.69', CURRENT_TIMESTAMP, '../img/koleno.jpeg');
INSERT INTO `item` (`item_id`, `item_name`, `item_description`, `item_price`, `last_update`, `item_image`) VALUES (NULL, 'Lamb', 'Perfect combination of lamb with tomato rice.', '2.55', CURRENT_TIMESTAMP, '../img/lamb.jpeg');
INSERT INTO `item` (`item_id`, `item_name`, `item_description`, `item_price`, `last_update`, `item_image`) VALUES (NULL, 'Fruit Snack (80g)', 'A selection of apple slices and grapes.', '1.89', CURRENT_TIMESTAMP, '../img/fruit.jpg');
INSERT INTO `item` (`item_id`, `item_name`, `item_description`, `item_price`, `last_update`, `item_image`) VALUES (NULL, 'Red Velvet Cake', 'Coloured sponge cake topped with vanilla frosting and decorated with a coloured sponge crumb.', '2.29', CURRENT_TIMESTAMP, '../img/rvCake.jpeg');
INSERT INTO `item` (`item_id`, `item_name`, `item_description`, `item_price`, `last_update`, `item_image`) VALUES (NULL, 'Strawberry cake', 'Layers of sponge sandwiched with cream and strawberries.', '2.05', CURRENT_TIMESTAMP, '../img/cake.jpeg');
INSERT INTO `item` (`item_id`, `item_name`, `item_description`, `item_price`, `last_update`, `item_image`) VALUES (NULL, 'Water (100ml)', 'Vapour distilled spring water with added electrolytes.', '0.75', CURRENT_TIMESTAMP, '../img/water.jpg');
INSERT INTO `item` (`item_id`, `item_name`, `item_description`, `item_price`, `last_update`, `item_image`) VALUES (NULL, 'Innocent Apple juice (100ml)', 'This is 100% pure fruit juice. There are no concentrates.', '1.25', CURRENT_TIMESTAMP, '../img/AppleJuice.jpeg');
INSERT INTO `item` (`item_id`, `item_name`, `item_description`, `item_price`, `last_update`, `item_image`) VALUES (NULL, 'Coke (330ml)', 'Sparkling Soft Drink with Vegetable Extracts. This product is GMO, gluten and allergen free.', '1.25', CURRENT_TIMESTAMP, '../img/coke.jpg');
